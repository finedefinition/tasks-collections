package arraylist.InsertInMiddleArrayList;

import java.util.ArrayList;

/*
В 3020 году ученые научились выращивать новые планеты, одну из которых
отправили в космос на орбиту Солнца.
...
Требования:
•	Метод createNewPlanet(String) должен добавлять переданную планету в
список planets на следующую позицию после Земли.
*/
